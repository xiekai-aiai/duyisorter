...
/* save parameters */
    ...
    for (int i = 0; i < MAX_LEVEL; i++) {
        for (int j = 0; j < MAX_BACKGROUND_GROUP; j++) {
            ...
            if(struCnfp.nBackgroundColor[i][j] != _t_struCnfp.nBackgroundColor[i][j]) {
                ...
                myLog->info(LOG_BACKGROUD,"bg(level:%d,bg No.:%d) color: %d",i,j,struCnfp.nBackgroundColor[i][j]);
            }
            ...
            if(struCnfp.nBackgroundColorValue[i][j] != _t_struCnfp.nBackgroundColorValue[i][j]) {
                ...
                myLog->info(LOG_BACKGROUD,"bg(level:%d,bg No.:%d) color value: %d",i,j,struCnfp.nBackgroundColorValue[i][j]);
            }
            ...
            if(struCnfp.nBackgroundColorPer[i][j] != _t_struCnfp.nBackgroundColorPer[i][j]) {
                ...
                myLog->info(LOG_BACKGROUD,"bg(level:%d,bg No.:%d) color percent: %d",i,j,struCnfp.nBackgroundColorPer[i][j]);
            }
        }
    }
    ...
    for (int i = 0; i < ARITHMETIC_TOTAL; i++) {
        if(struCnfp.nArithmeticEnable[i] != _t_struCnfp.nArithmeticEnable[i]) {
            ...
            myLog->info(LOG_ARITH,"arith name :%s, enable status: %d",qPrintable(myString.sArithmeticName[i]),
    ...
    if(struCnfp.nIntelMode != _t_struCnfp.nIntelMode) {
        ...
        myLog->info(LOG_ARITH,"intel mode: %d",struCnfp.nIntelMode);
    }
    ...
    for (int i = 0; i < MAX_LEVEL; i++) {
        ...
        /* color */
            for (int k = 0; k < 4; k++) {
                ...
                if (memcmp(struCnfp.struGroupIdentify[i][j].struGreyColor[k].sName, _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].sName,
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                                    i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].sName);
                }
                /* row */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nRow != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nRow) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nRow);
                }
                /* column */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColumn != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColumn) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColumn);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nPercent != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nPercent) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nPercent);
                }
                /* color */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColor != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColor) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, grey color: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nColor);
                }
                /* discolor */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nDiscolor != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nDiscolor) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, discolor: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nDiscolor);
                }
                /* sens min */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMin != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMin) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens min: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMin);
                }
                /* sens max */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMax != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMax) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens max: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nSensMax);
                }
                /* mode */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nMode != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nMode) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, mode: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nMode);
                }
                /* light limit */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nLightLimit != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nLightLimit) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, light limit: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nLightLimit);
                }
                /* nBurntReservedFlag */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].nBurntReservedFlag != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].nBurntReservedFlag) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, Burnt Reserved Flag: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].nBurntReservedFlag);
                }
                ...
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nDiscolor1 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nDiscolor1) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nDiscolor1);
                }
                /* sens min 1 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin1 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin1) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens min: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin1);
                }
                /* sens max 1 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax1 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax1) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens max: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax1);
                }
                /* mode 1 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode1 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode1) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor mode: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode1);
                }
                /* color 2 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nColor2 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nColor2) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey color: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nColor2);
                }
                /* sens min 2 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin2 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin2) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens min: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMin2);
                }
                /* sens max 2 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax2 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax2) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens max: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nSensMax2);
                }
                /* mode 2 */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode2 != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode2) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey mode: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nMode2);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nPercent != _t_struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nPercent) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey percent: %d",
                                i,j,myString.sArithmeticName[k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struGreyColor[k].struReserved.nPercent);
                }
        ...
        /* cross */
           ...
           if (memcmp(struCnfp.struGroupIdentify[i][j].struCross.sName, _t_struCnfp.struGroupIdentify[i][j].struCross.sName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.sName);
           }
            /* row */
           if(struCnfp.struGroupIdentify[i][j].struCross.nRow != _t_struCnfp.struGroupIdentify[i][j].struCross.nRow) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.nRow);
           }
            /* column */
            if(struCnfp.struGroupIdentify[i][j].struCross.nColumn != _t_struCnfp.struGroupIdentify[i][j].struCross.nColumn) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.nColumn);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struCross.nPercent != _t_struCnfp.struGroupIdentify[i][j].struCross.nPercent) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.nPercent);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struCross.nSens != _t_struCnfp.struGroupIdentify[i][j].struCross.nSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens: %d",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.nSens);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struCross.nColor != _t_struCnfp.struGroupIdentify[i][j].struCross.nColor) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, color: %d",
                            i,j,myString.sArithmeticName[ARITH_CROSS].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struCross.nColor);
            }
        ...
        /* shape */
            ...
            if (memcmp(struCnfp.struGroupIdentify[i][j].struShape.sName, _t_struCnfp.struGroupIdentify[i][j].struShape.sName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.sName);
            }
            /* area min */
            if(struCnfp.struGroupIdentify[i][j].struShape.nAreaMin != _t_struCnfp.struGroupIdentify[i][j].struShape.nAreaMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, area min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nAreaMin);
            }
            /* area max */
            ...
            if(struCnfp.struGroupIdentify[i][j].struShape.nMode != _t_struCnfp.struGroupIdentify[i][j].struShape.nMode) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, mode: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nMode);
            }
            /* length name */
            if(memcmp(struCnfp.struGroupIdentify[i][j].struShape.sLengthName, _t_struCnfp.struGroupIdentify[i][j].struShape.sLengthName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LENGTH].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.sLengthName);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struShape.nLengthMin != _t_struCnfp.struGroupIdentify[i][j].struShape.nLengthMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, length min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LENGTH].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nLengthMin);
            }
            /* length max */
            if(struCnfp.struGroupIdentify[i][j].struShape.nLengthMax != _t_struCnfp.struGroupIdentify[i][j].struShape.nLengthMax) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, length max: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LENGTH].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nLengthMax);
            }
            /* length mode */
            if(struCnfp.struGroupIdentify[i][j].struShape.nLengthMode != _t_struCnfp.struGroupIdentify[i][j].struShape.nLengthMode) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, length mode: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LENGTH].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nLengthMode);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struShape.nLengthLimit != _t_struCnfp.struGroupIdentify[i][j].struShape.nLengthLimit) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, length limit: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LENGTH].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nLengthLimit);
            }
            /* length limit */
            if(struCnfp.struGroupIdentify[i][j].struShape.nAreaLimit != _t_struCnfp.struGroupIdentify[i][j].struShape.nAreaLimit) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, length limit: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struShape.nAreaLimit);
            }
        /* scale */
            for (int k = 0; k < 2; k++) {
                /* name */
                if (memcmp(struCnfp.struGroupIdentify[i][j].struScale[k].sName, _t_struCnfp.struGroupIdentify[i][j].struScale[k].sName,
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                                i,j,myString.sArithmeticName[ARITH_SCALE+k*(ARITH_SCALE-ARITH_SCALE_B)].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struScale[k].sName);
                }
                /* mode */
                if(struCnfp.struGroupIdentify[i][j].struScale[k].nMode != _t_struCnfp.struGroupIdentify[i][j].struScale[k].nMode) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, mode: %d",
                                i,j,myString.sArithmeticName[ARITH_SCALE+k*(ARITH_SCALE-ARITH_SCALE_B)].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struScale[k].nMode);
                }
                /* value */
                if(struCnfp.struGroupIdentify[i][j].struScale[k].nValue != _t_struCnfp.struGroupIdentify[i][j].struScale[k].nValue) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens: %d",
                                i,j,myString.sArithmeticName[ARITH_SCALE+k*(ARITH_SCALE-ARITH_SCALE_B)].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struScale[k].nValue);
                }
                /* value limit */
                if(struCnfp.struGroupIdentify[i][j].struScale[k].nValueLimit != _t_struCnfp.struGroupIdentify[i][j].struScale[k].nValueLimit) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, limit: %d",
                                i,j,myString.sArithmeticName[ARITH_SCALE+k*(ARITH_SCALE-ARITH_SCALE_B)].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struScale[k].nValueLimit);
                }
            }
        ...
        /* bud */
            for (int k = 0; k < 2; k++) {
                ...
                if (memcmp(struCnfp.struGroupIdentify[i][j].struBud[k].sName, _t_struCnfp.struGroupIdentify[i][j].struBud[k].sName,
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].sName);
                }
                /* row */
                if(struCnfp.struGroupIdentify[i][j].struBud[k].nRow != _t_struCnfp.struGroupIdentify[i][j].struBud[k].nRow) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].nRow);
                }
                /* column */
                if(struCnfp.struGroupIdentify[i][j].struBud[k].nColumn != _t_struCnfp.struGroupIdentify[i][j].struBud[k].nColumn) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].nColumn);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struBud[k].nPercent != _t_struCnfp.struGroupIdentify[i][j].struBud[k].nPercent) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].nPercent);
                }
                /* percent limit */
                if(struCnfp.struGroupIdentify[i][j].struBud[k].nPercentLimit != _t_struCnfp.struGroupIdentify[i][j].struBud[k].nPercentLimit) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure limit: %d",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].nPercentLimit);
                }
                /* area */
                if(struCnfp.struGroupIdentify[i][j].struBud[k].nArea != _t_struCnfp.struGroupIdentify[i][j].struBud[k].nArea) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, area(sens): %d",
                                i,j,myString.sArithmeticName[ARITH_BUD_1+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struBud[k].nArea);
                }
            }
        ...
        /* peanut */
            for (int k = 0; k < 4; k++) {
                ...
                if (memcmp(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].sName, _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].sName,
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].sName);
                }
                /* row */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nRow != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nRow) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nRow);
                }
                /* column */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nColumn != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nColumn) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nColumn);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nPercent != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nPercent) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nPercent);
                }
                /* sens min */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMin != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMin) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens min: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMin);
                }
                /* sens max */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMax != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMax) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens max: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensMax);
                }
                /* mode */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nMode != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nMode) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, mode: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nMode);
                }
                /* sens reserved */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensReserved != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensReserved) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens reserved: %d",
                                i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].nSensReserved);
                }
                ...
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nDiscolor1 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nDiscolor1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nDiscolor1);
                }
                    /* sens min 1 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin1 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens min: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin1);
                }
                    /* sens max 1 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax1 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens max: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax1);
                }
                    /* mode 1 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode1 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor mode: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode1);
                }
                    /* color 2 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nColor2 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nColor2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey color: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nColor2);
                }
                    /* sens min 2 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin2 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens min: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMin2);
                }
                    /* sens max 2 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax2 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens max: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nSensMax2);
                }
                    /* mode 2 */
                if(struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode2 != _t_struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey mode: %d",
                                    i,j,myString.sArithmeticName[ARITH_PEANUT_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPeanutAbcd[k].struReserved.nMode2);
                }
        ...
        /* intel */
            for (int k = 0; k < 4; k++) {
                ...
                if (memcmp(struCnfp.struGroupIdentify[i][j].struIntel[k].sName, _t_struCnfp.struGroupIdentify[i][j].struIntel[k].sName,
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].sName);
                }
                /* row */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nRow != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nRow) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nRow);
                }
                /* column */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nColumn != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nColumn) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nColumn);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nPercent != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nPercent) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, percent: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nPercent);
                }
                /* balance */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nEnable != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nEnable) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, balance: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nEnable);
                }
                /* sens */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nSens != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nSens) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nSens);
                }
                /* whole edge */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nWholeEdge != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nWholeEdge) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, whole edge: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nWholeEdge);
                }
                ...
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nDiscolor1 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nDiscolor1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nDiscolor1);
                ...
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin1 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens min: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin1);
                }
                    /* sens max 1 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax1 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens max: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax1);
                }
                    /* mode 1 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode1 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode1) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor mode: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode1);
                }
                    /* color 2 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nColor2 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nColor2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey color: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nColor2);
                }
                /* sens min 2 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin2 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens min: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMin2);
                }
                /* sens max 2 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax2 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens max: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nSensMax2);
                }
                /* mode 2 */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode2 != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode2) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey mode: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nMode2);
                }
                /* percent */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nPercent != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nPercent) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey percent: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].struReserved.nPercent);
                }
                ...
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nModeDfl != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nModeDfl) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sort mode dfl: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nModeDfl);
                }
                ...
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nSensRatio != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nSensRatio) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, nSensRatio: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nSensRatio);
                }
                /* nIntelType */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nIntelType != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nIntelType) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, nIntelType: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nIntelType);
                }
                ...
                /* normal */
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nCons[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nCons[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, constant[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nCons[m]);
                    }
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo1[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo1[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, quo1[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo1[m]);
                    }
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo2[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo2[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, quo2[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo2[m]);
                    }
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo3[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo3[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, quo3[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuo3[m]);
                    }
                ...
                /* multi mode */
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nConsDfl[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nConsDfl[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, dfl constant[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nConsDfl[m]);
                    }
                    /* r */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoR[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoR[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, R quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoR[m]);
                    ...
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoG[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoG[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, G quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoG[m]);
                    }
                    /* b */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoB[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoB[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, B quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoB[m]);
                    }
                    /* rr */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRR[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRR[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, RR quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRR[m]);
                    }
                    /* gg */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGG[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGG[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, GG quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGG[m]);
                    }
                    /* bb */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoBB[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoBB[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, BB quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoBB[m]);
                    }
                    /* rg */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRG[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRG[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, RG quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRG[m]);
                    }
                    /* rb */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRB[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRB[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, RB quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoRB[m]);
                    }
                    /* gb */
                    if(struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGB[m] != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGB[m]) {
                        ...
                        myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, GB quo[%d]: %d",
                                    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),m,struCnfp.struGroupIdentify[i][j].struIntel[k].nQuoGB[m]);
                    }
		}
		/* ratio mode */
		if(struCnfp.struGroupIdentify[i][j].struIntel[k].nRatioMode != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nRatioMode) {
		    ...
		    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sort mode ratio: %d",
			    i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nRatioMode);
		}
		/* rowRes */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nRowRes != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nRowRes) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, rowRes: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nRowRes);
                }
                /* columnRes */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nColumnRes != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nColumnRes) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, columnRes: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nColumnRes);
                }
                /* percentRes */
                if(struCnfp.struGroupIdentify[i][j].struIntel[k].nPercentRes != _t_struCnfp.struGroupIdentify[i][j].struIntel[k].nPercentRes) {
                    ...
                    myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, percentRes: %d",
                                i,j,myString.sArithmeticName[ARITH_INTEL_A+k].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struIntel[k].nPercentRes);
                }
            }
        ...
        /* melon */
            ...
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteSens != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, white sens: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteSens);
            }
            /* white prop min */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMin != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, white propt min: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMin);
            }
            /* white prop max */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMax != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMax) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, white propt max: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nWhitePropMax);
            }
            /* white mode */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteMode != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteMode) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, white mode: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nWhiteMode);
            }
            /* edge red sens */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedSens != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, edge red sens: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedSens);
            }
            /* edge red ratio */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedRatio != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedRatio) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, edge red ratio: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeRedRatio);
            }
            /* edge damage sens */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedSens != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, edge damage sens: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedSens);
            }
            /* edge damage ratio */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedRatio != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedRatio) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, edge damage ratio: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nEdgeDamagedRatio);
            }
            /* rugged 1 sens */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Sens != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Sens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, rugged 1 sens: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Sens);
            }
            /* rugged 1 save */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Save != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Save) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, rugged 1 save: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged1Save);
            }
            /* rugged 2 sens */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Sens != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Sens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, rugged 2 sens: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Sens);
            }
            /* rugged 2 save */
            if(struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Save != _t_struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Save) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, rugged 2 save: %d",
                            i,j,myString.sArithmeticName[ARITH_WATERMELON].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMatMelon.nRugged2Save);
            }
            ...
            if(struCnfp.struGroupIdentify[i][j].struRice.nSens != _t_struCnfp.struGroupIdentify[i][j].struRice.nSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master sens: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nSens);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nBadDiscolor != _t_struCnfp.struGroupIdentify[i][j].struRice.nBadDiscolor) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master bad discolor: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nBadDiscolor);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nRow != _t_struCnfp.struGroupIdentify[i][j].struRice.nRow) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master row: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nRow);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nCol != _t_struCnfp.struGroupIdentify[i][j].struRice.nCol) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master column: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nCol);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nYellowArea != _t_struCnfp.struGroupIdentify[i][j].struRice.nYellowArea) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master area: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nYellowArea);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nBadWidth != _t_struCnfp.struGroupIdentify[i][j].struRice.nBadWidth) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master bad width: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nBadWidth);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nDarkSens != _t_struCnfp.struGroupIdentify[i][j].struRice.nDarkSens) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, master dark sens: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nDarkSens);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nReservePercent1 != _t_struCnfp.struGroupIdentify[i][j].struRice.nReservePercent1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, slave reserve percent: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nReservePercent1);
            }
            if(struCnfp.struGroupIdentify[i][j].struRice.nReservePercent2 != _t_struCnfp.struGroupIdentify[i][j].struRice.nReservePercent2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, slave reserve percent: %d",
                            i,j,myString.sArithmeticName[ARITH_RICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struRice.nReservePercent2);
            }
          ...
          /* maize */
            ...
            if(struCnfp.struGroupIdentify[i][j].struMaize.nRow != _t_struCnfp.struGroupIdentify[i][j].struMaize.nRow) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, row: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nRow);
            }
            /* nPercentTotal */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nPercentTotal != _t_struCnfp.struGroupIdentify[i][j].struMaize.nPercentTotal) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, total pure percent: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nPercentTotal);
            }
            /* nPercentGood */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nPercentGood != _t_struCnfp.struGroupIdentify[i][j].struMaize.nPercentGood) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, total good percent: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nPercentGood);
            }
            /* nPercentBad1 */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad1 != _t_struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, total bad 1 percent: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad1);
            }
            /* nPercentBad2 */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad2 != _t_struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, total bad 2 percent: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nPercentBad2);
            }
            /* nSensMin1 */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nSensMin1 != _t_struCnfp.struGroupIdentify[i][j].struMaize.nSensMin1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens 1: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nSensMin1);
            }
            /* nSensProport */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nSensProport != _t_struCnfp.struGroupIdentify[i][j].struMaize.nSensProport) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, proport sens: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nSensProport);
            }
            /* nSensMin2 */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nSensMin2 != _t_struCnfp.struGroupIdentify[i][j].struMaize.nSensMin2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, sens 2: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nSensMin2);
            }
            /* nColumn */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nColumn != _t_struCnfp.struGroupIdentify[i][j].struMaize.nColumn) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, column: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nColumn);
            }
            /* nColumn */
            if(struCnfp.struGroupIdentify[i][j].struMaize.nThreshold != _t_struCnfp.struGroupIdentify[i][j].struMaize.nThreshold) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, threshold: %d",
                            i,j,myString.sArithmeticName[ARITH_MAIZE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struMaize.nThreshold);
            }
        ...
        /* 选杆算法 */
            ...
            if (memcmp(struCnfp.struGroupIdentify[i][j].struPole.sName, _t_struCnfp.struGroupIdentify[i][j].struPole.sName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.sName);
            }
            /* nArea */
            if (struCnfp.struGroupIdentify[i][j].struPole.nArea != _t_struCnfp.struGroupIdentify[i][j].struPole.nArea) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, area: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nArea);
            }
            /* nPercent */
            if (struCnfp.struGroupIdentify[i][j].struPole.nPercent != _t_struCnfp.struGroupIdentify[i][j].struPole.nPercent) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nPercent);
            }
            /* nWidthMin */
            if (struCnfp.struGroupIdentify[i][j].struPole.nWidthMin != _t_struCnfp.struGroupIdentify[i][j].struPole.nWidthMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, width min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nWidthMin);
            }
            /* nWidthMax */
            if (struCnfp.struGroupIdentify[i][j].struPole.nWidthMax != _t_struCnfp.struGroupIdentify[i][j].struPole.nWidthMax) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, width max: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nWidthMax);
            }
            ...
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nDiscolor1 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nDiscolor1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nDiscolor1);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode1 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor mode: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode1);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin1 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin1);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax1 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax1) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved discolor sens max: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax1);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nColor2 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nColor2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey color: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nColor2);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode2 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey mode: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nMode2);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin2 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMin2);
            }
            if (struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax2 != _t_struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax2) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, reserved grey sens max: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.struReserved.nSensMax2);
            }
        ...
        /* wide pole name */
            if (memcmp(struCnfp.struGroupIdentify[i][j].struPole.sPoleName, _t_struCnfp.struGroupIdentify[i][j].struPole.sPoleName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material(wide pole) name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.sPoleName);
            }
        ...
        /* wide pole area */
            if (struCnfp.struGroupIdentify[i][j].struPole.nPoleArea != _t_struCnfp.struGroupIdentify[i][j].struPole.nPoleArea) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, wide pole area: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nPoleArea);
            }
        ...
        /* wide pole percent */
            if (struCnfp.struGroupIdentify[i][j].struPole.nPolePercent != _t_struCnfp.struGroupIdentify[i][j].struPole.nPolePercent) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, wide pole percent: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nPolePercent);
            }
        ...
        /* wide pole min */
            if (struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMin != _t_struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, wide pole width min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMin);
            }
        ...
        /* wide pole max */
            if (struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMax != _t_struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMax) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, wide pole width max: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_POLE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struPole.nPoleWidthMax);
            }
    ...
    /* 选片算法 */
        /* slice name */
            if (memcmp(struCnfp.struGroupIdentify[i][j].struSlice.sName, _t_struCnfp.struGroupIdentify[i][j].struSlice.sName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material(slice name) name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_SLICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struSlice.sName);
            }
            /* slice area */
            if (struCnfp.struGroupIdentify[i][j].struSlice.nArea != _t_struCnfp.struGroupIdentify[i][j].struSlice.nArea) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, area: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_SLICE].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struSlice.nArea);
            }
    ...
    /* 选芽算法 */
        /* leaf name */
            if (memcmp(struCnfp.struGroupIdentify[i][j].struLeaf.sName, _t_struCnfp.struGroupIdentify[i][j].struLeaf.sName,
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, material(leaf name) name: %s",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LEAF].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struLeaf.sName);
            }
        ...
        /* leaf area */
            if (struCnfp.struGroupIdentify[i][j].struLeaf.nArea != _t_struCnfp.struGroupIdentify[i][j].struLeaf.nArea) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, area: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LEAF].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struLeaf.nArea);
            }
        ...
        /* leaf percent */
            if (struCnfp.struGroupIdentify[i][j].struLeaf.nPercent != _t_struCnfp.struGroupIdentify[i][j].struLeaf.nPercent) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, pure percent: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LEAF].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struLeaf.nPercent);
            }
        ...
        /* leaf width min */
            if (struCnfp.struGroupIdentify[i][j].struLeaf.nWidthMin != _t_struCnfp.struGroupIdentify[i][j].struLeaf.nWidthMin) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, width min: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LEAF].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struLeaf.nWidthMin);
            }
        ...
        /* leaf threshold */
            if (struCnfp.struGroupIdentify[i][j].struLeaf.nThreshold != _t_struCnfp.struGroupIdentify[i][j].struLeaf.nThreshold) {
                ...
                myLog->info(LOG_ARITH,"level: %d, identify group: %d, arith name: %s, threshold: %d",
                            i,j,myString.sArithmeticName[ARITH_SHAPE_LEAF].toLocal8Bit().constData(),struCnfp.struGroupIdentify[i][j].struLeaf.nThreshold);
            }
...
//          }
    ...
    for (int i = 0; i < MAX_LEVEL; i++) {
        for (int j = 0; j < MAX_GROUP_TICK; j++) {
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDuration != _t_struCnfp.struGroupTick[i][j].nEjectDuration) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject duration: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDuration);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDelay != _t_struCnfp.struGroupTick[i][j].nEjectDelay) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject delay: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDelay);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nFrontRearMode != _t_struCnfp.struGroupTick[i][j].nFrontRearMode) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, front & rear mode: %d",i,j,struCnfp.struGroupTick[i][j].nFrontRearMode);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nImpuredFlag != _t_struCnfp.struGroupTick[i][j].nImpuredFlag) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, infect enable: %d",i,j,struCnfp.struGroupTick[i][j].nImpuredFlag);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjwidth != _t_struCnfp.struGroupTick[i][j].nEjwidth) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject width: %d",i,j,struCnfp.struGroupTick[i][j].nEjwidth);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEdgeCut != _t_struCnfp.struGroupTick[i][j].nEdgeCut) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject cut: %d",i,j,struCnfp.struGroupTick[i][j].nEdgeCut);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nBadNum != _t_struCnfp.struGroupTick[i][j].nBadNum) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, bad num: %d",i,j,struCnfp.struGroupTick[i][j].nBadNum);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nReverseSort != _t_struCnfp.struGroupTick[i][j].nReverseSort) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, reverse sort: %d",i,j,struCnfp.struGroupTick[i][j].nReverseSort);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nMatWidth != _t_struCnfp.struGroupTick[i][j].nMatWidth) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, material width: %d",i,j,struCnfp.struGroupTick[i][j].nMatWidth);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nGoodNum != _t_struCnfp.struGroupTick[i][j].nGoodNum) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, good num: %d",i,j,struCnfp.struGroupTick[i][j].nGoodNum);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEdgeRevise != _t_struCnfp.struGroupTick[i][j].nEdgeRevise) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, edge revise: %d",i,j,struCnfp.struGroupTick[i][j].nEdgeRevise);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEnableBalance != _t_struCnfp.struGroupTick[i][j].nEnableBalance) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, enable balance: %d",i,j,struCnfp.struGroupTick[i][j].nEnableBalance);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectTimesLimit != _t_struCnfp.struGroupTick[i][j].nEjectTimesLimit) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject times limit: %d",i,j,struCnfp.struGroupTick[i][j].nEjectTimesLimit);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDegauss != _t_struCnfp.struGroupTick[i][j].nEjectDegauss) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject degauss: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDegauss);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nMatArea != _t_struCnfp.struGroupTick[i][j].nMatArea) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, material area: %d",i,j,struCnfp.struGroupTick[i][j].nMatArea);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDurationCent != _t_struCnfp.struGroupTick[i][j].nEjectDurationCent) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject duration cent: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDurationCent);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDelayCent != _t_struCnfp.struGroupTick[i][j].nEjectDelayCent) {
                ...
                myLog->info(LOG_ARITH,"level: %d, reject group: %d, eject delay cent: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDelayCent);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nImpured != _t_struCnfp.struGroupTick[i][j].nImpured) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, infect num: %d",i,j,struCnfp.struGroupTick[i][j].nImpured);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nCorrupted != _t_struCnfp.struGroupTick[i][j].nCorrupted) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, corrupted num: %d",i,j,struCnfp.struGroupTick[i][j].nCorrupted);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nExpanded != _t_struCnfp.struGroupTick[i][j].nExpanded) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, expanded num: %d",i,j,struCnfp.struGroupTick[i][j].nExpanded);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nShapeImpured != _t_struCnfp.struGroupTick[i][j].nShapeImpured) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, shape infect num: %d",i,j,struCnfp.struGroupTick[i][j].nShapeImpured);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nShapeCorrupted != _t_struCnfp.struGroupTick[i][j].nShapeCorrupted) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, shape corrupted num: %d",i,j,struCnfp.struGroupTick[i][j].nShapeCorrupted);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nShapeExpanded != _t_struCnfp.struGroupTick[i][j].nShapeExpanded) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, shape expanded num: %d",i,j,struCnfp.struGroupTick[i][j].nShapeExpanded);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nAssistEjectTime != _t_struCnfp.struGroupTick[i][j].nAssistEjectTime) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, assist eject time: %d",i,j,struCnfp.struGroupTick[i][j].nAssistEjectTime);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nAssistDelayTime != _t_struCnfp.struGroupTick[i][j].nAssistDelayTime) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, assist delay time: %d",i,j,struCnfp.struGroupTick[i][j].nAssistDelayTime);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nRemoveJoint != _t_struCnfp.struGroupTick[i][j].nRemoveJoint) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, remove joint: %d",i,j,struCnfp.struGroupTick[i][j].nRemoveJoint);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nEjectDelayBias != _t_struCnfp.struGroupTick[i][j].nEjectDelayBias) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, nEjectDelayBias: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDelayBias);
            }
            if(struCnfp.struGroupTick[i][j].nEjectDelayBiasCent != _t_struCnfp.struGroupTick[i][j].nEjectDelayBiasCent) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, nEjectDelayBiasCent: %d",i,j,struCnfp.struGroupTick[i][j].nEjectDelayBiasCent);
            }
            /* eject truncation */
            if(struCnfp.struGroupTick[i][j].nEjectTruncation != _t_struCnfp.struGroupTick[i][j].nEjectTruncation) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, eject truncation: %d",i,j,struCnfp.struGroupTick[i][j].nEjectTruncation);
            }
            ...
            if(struCnfp.struGroupTick[i][j].nAssistEjectDegauss != _t_struCnfp.struGroupTick[i][j].nAssistEjectDegauss) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d,Assist eject degauss: %d",i,j,struCnfp.struGroupTick[i][j].nAssistEjectDegauss);
            }
            /* Assist eject truncation */
            if(struCnfp.struGroupTick[i][j].nAssistEjectTruncation != _t_struCnfp.struGroupTick[i][j].nAssistEjectTruncation) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d,Assist eject truncation: %d",i,j,struCnfp.struGroupTick[i][j].nAssistEjectTruncation);
            }
            /* 吹气宽度 huff width */
            if(struCnfp.struGroupTick[i][j].nhuffWidth != _t_struCnfp.struGroupTick[i][j].nhuffWidth) {
                ...
                myLog->info(LOG_EJECT,"level: %d, reject group: %d, huff Width: %d",i,j,struCnfp.struGroupTick[i][j].nhuffWidth);
            }
    ...
    for (int i = 0; i < MAX_CTRL; i++) {
        ...
        for (int j = 0; j < 10; j++) {
            if(struCnfp.struGroupCtrl[i].nFeeder[j] != _t_struCnfp.struGroupCtrl[i].nFeeder[j]) {
                ...
                myLog->info(LOG_FEED,"control No.: %d, feeder No.: %d, feeder value: %d",i,j,struCnfp.struGroupCtrl[i].nFeeder[j]);
            }
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeDuration != _t_struCnfp.struGroupCtrl[i].nWipeDuration) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe duration: %d",i,struCnfp.struGroupCtrl[i].nWipeDuration);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeInterval != _t_struCnfp.struGroupCtrl[i].nWipeInterval) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe interval: %d",i,struCnfp.struGroupCtrl[i].nWipeInterval);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nLiftTimeBeforeWipe != _t_struCnfp.struGroupCtrl[i].nLiftTimeBeforeWipe) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe duration: %d",i,struCnfp.struGroupCtrl[i].nLiftTimeBeforeWipe);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nLiftTimeAfterWipe != _t_struCnfp.struGroupCtrl[i].nLiftTimeAfterWipe) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe duration: %d",i,struCnfp.struGroupCtrl[i].nLiftTimeAfterWipe);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeWindDuration != _t_struCnfp.struGroupCtrl[i].nWipeWindDuration) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe wind duration: %d",i,struCnfp.struGroupCtrl[i].nWipeWindDuration);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeWindInterval != _t_struCnfp.struGroupCtrl[i].nWipeWindInterval) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe wind interval: %d",i,struCnfp.struGroupCtrl[i].nWipeWindInterval);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nBackgroundFront != _t_struCnfp.struGroupCtrl[i].nBackgroundFront) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, front background angle: %d",i,struCnfp.struGroupCtrl[i].nBackgroundFront);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nBackgroundRear != _t_struCnfp.struGroupCtrl[i].nBackgroundRear) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, rear background angle: %d",i,struCnfp.struGroupCtrl[i].nBackgroundRear);
        }
        ...
        for (int j = 0; j < MAX_LAMP; j++) {
            if(struCnfp.struGroupCtrl[i].nLamp[j] != _t_struCnfp.struGroupCtrl[i].nLamp[j]) {
                ...
                myLog->info(LOG_BACKGROUD,"lamp(level:%d,lamp No.:%d) switch: %d",i,j,struCnfp.struGroupCtrl[i].nLamp[j]);
            }
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeWaterDuration != _t_struCnfp.struGroupCtrl[i].nWipeWaterDuration) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe water duration: %d",i,struCnfp.struGroupCtrl[i].nWipeWaterDuration);
        }
        if(struCnfp.struGroupCtrl[i].nWipeWaterDelay != _t_struCnfp.struGroupCtrl[i].nWipeWaterDelay) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe water delay: %d",i,struCnfp.struGroupCtrl[i].nWipeWaterDelay);
        }
        ...
        for(int j=0; j<10; j++) {
            if(struCnfp.struGroupCtrl[i].nFeederEnable[j] != _t_struCnfp.struGroupCtrl[i].nFeederEnable[j]) {
                ...
                myLog->info(LOG_FEED,"control No.: %d, feeder No.: %d, feeder status: %d",i,j,struCnfp.struGroupCtrl[i].nFeederEnable[j]);
            }
        }
        ...
        for(int j=0; j<MAX_LAMP; j++) {
            if(struCnfp.struGroupCtrl[i].nLampLight[j] != _t_struCnfp.struGroupCtrl[i].nLampLight[j]) {
                    ...
                    myLog->info(LOG_BACKGROUD,"lamp(level:%d,lamp No.:%d) strength: %d",i,j,struCnfp.struGroupCtrl[i].nLampLight[j]);
            }
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeDuration2 != _t_struCnfp.struGroupCtrl[i].nWipeDuration2) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe duration2: %d",i,struCnfp.struGroupCtrl[i].nWipeDuration2);
        }
        ...
        if(struCnfp.struGroupCtrl[i].nWipeDelay != _t_struCnfp.struGroupCtrl[i].nWipeDelay) {
            ...
            myLog->info(LOG_WIPE,"control No.: %d, wipe delay: %d",i,struCnfp.struGroupCtrl[i].nWipeDelay);
        }
    }
    ...
    for (int i = 0; i < MAX_LEVEL; i++) {
        for (int j = 0; j < ARITHMETIC_TOTAL; j++) {
            if (struCnfp.nArithmeticEnableLevel[i][j] != _t_struCnfp.nArithmeticEnableLevel[i][j]) {
                ...
                myLog->info(LOG_ARITH,"level:%d, arith name: %s, enable status: %d",i,qPrintable(myString.sArithmeticName[j]),struCnfp.nArithmeticEnableLevel[i][j]);
            }
        }
    }
    ...
    for (int i = 0; i < MAX_UNIT; i++) {
        for (int j = 0; j < ARITHMETIC_TOTAL; j++) {
            if (struCnfp.nSensBias[i][j] != _t_struCnfp.nSensBias[i][j]) {
                ...
                myLog->info(LOG_ARITH,"camera No.:%d, arith name: %s, sens bias: %d",i,qPrintable(myString.sArithmeticName[j]),struCnfp.nSensBias[i][j]);
            }
        }
        for (int j = 0; j < MAX_MAIZE_SENSNUM_TOTAL; j++) {
            if (struCnfp.nSensBiasMaize[i][j] != _t_struCnfp.nSensBiasMaize[i][j]) {
                ...
                myLog->info(LOG_ARITH,"camera No.:%d, arith name: %s, sens No. %d, bias: %d",i,qPrintable(myString.sArithmeticName[ARITH_MAIZE]),i,struCnfp.nSensBiasMaize[i][j]);
            }
        }
    }
    ...
    for (int i = 0; i < MAX_LEVEL; i++) {
        for (int j = 0; j < MAX_UNIT; j++) {
            if (struCnfp.nAutoBgEnable[i][j] != _t_struCnfp.nAutoBgEnable[i][j]) {
                ...
                myLog->info(LOG_BACKGROUD,"bg(level:%d,unit.:%d) bg auto enable: %d",i,j,struCnfp.nAutoBgEnable[i][j]);
            }
        }
    }
    for (int i = 0; i < MAX_LEVEL; i++) {
        for (int j = 0; j < MAX_UNIT; j++) {
            for (int k = 0; k < 3; k++) {
                if (struCnfp.nAutoBgRange[i][j][k] != _t_struCnfp.nAutoBgRange[i][j][k]) {
                    ...
                    myLog->info(LOG_BACKGROUD,"bg(level:%d,unit:%d,rgb:%d) bg auto range: %d",i,j,k,struCnfp.nAutoBgRange[i][j][k]);
                }
            }
        }
    }
    ...
    myLog->info(LOG_BACKGROUD,"autoBackground enable: %d",struCnfp.nAutoBackgroundEnanble_RSC);
    //下位机自动背景阈值
    setting.setValue(QString("%1-%2").arg(3).arg(54), struCnfp.nAutoBackgroundThresholdValue_RSC);
    myLog->info(LOG_BACKGROUD,"autoBackground ThresholdValue: %d",struCnfp.nAutoBackgroundThresholdValue_RSC);
