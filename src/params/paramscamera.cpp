...
bool GlobalFlow::saveCameraSetting(const QString& fileName)
{
    ...
    for (int i = 0; i < MAX_LEVEL; i++)
    {
        for (int j = 0; j < MAX_UNIT; j++)
        {
            ...
            if (struCnfc.struLevelCamera[i].nChannelBegin[j] != _t_struCnfc.struLevelCamera[i].nChannelBegin[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) channel begin:%d", i, j, struCnfc.struLevelCamera[i].nChannelBegin[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nChannelEnd[j] != _t_struCnfc.struLevelCamera[i].nChannelEnd[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) channel end:%d", i, j, struCnfc.struLevelCamera[i].nChannelEnd[j]);
            }
            ...
            for (int k = 0; k < 2; k++)
            {
                if (struCnfc.struLevelCamera[i].nMaizeChannelBegin[j][k] != _t_struCnfc.struLevelCamera[i].nMaizeChannelBegin[j][k])
                {
                    ...
                    LOG_INFO_FMT("camera(level:%d,camera No.:%d) channel begin:%d", i, j, struCnfc.struLevelCamera[i].nMaizeChannelBegin[j][k]);
                }
                if (struCnfc.struLevelCamera[i].nMaizeChannelEnd[j][k] != _t_struCnfc.struLevelCamera[i].nMaizeChannelEnd[j][k])
                {
                    ...
                    LOG_INFO_FMT("camera(level:%d,camera No.:%d) channel end:%d", i, j, struCnfc.struLevelCamera[i].nMaizeChannelEnd[j][k]);
                }
            }
            ...
            if (struCnfc.struLevelCamera[i].nBiasingRed[j] != _t_struCnfc.struLevelCamera[i].nBiasingRed[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) red bias:%d", i, j, struCnfc.struLevelCamera[i].nBiasingRed[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nBiasingGreen[j] != _t_struCnfc.struLevelCamera[i].nBiasingGreen[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) green bias:%d", i, j, struCnfc.struLevelCamera[i].nBiasingGreen[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nBiasingBlue[j] != _t_struCnfc.struLevelCamera[i].nBiasingBlue[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) blue bias:%d", i, j, struCnfc.struLevelCamera[i].nBiasingBlue[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nAnaGainRed[j] != _t_struCnfc.struLevelCamera[i].nAnaGainRed[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) red analog gain:%d", i, j, struCnfc.struLevelCamera[i].nAnaGainRed[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nAnaGainGreen[j] != _t_struCnfc.struLevelCamera[i].nAnaGainGreen[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) green analog gain:%d", i, j, struCnfc.struLevelCamera[i].nAnaGainGreen[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nAnaGainBlue[j] != _t_struCnfc.struLevelCamera[i].nAnaGainBlue[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) blue analog gain:%d", i, j, struCnfc.struLevelCamera[i].nAnaGainBlue[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainUpperRed[j] != _t_struCnfc.struLevelCamera[i].nDigiGainUpperRed[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) red dig gain(high byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainUpperRed[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainUpperGreen[j] != _t_struCnfc.struLevelCamera[i].nDigiGainUpperGreen[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) green dig gain(high byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainUpperGreen[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainUpperBlue[j] != _t_struCnfc.struLevelCamera[i].nDigiGainUpperBlue[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) blue dig gain(high byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainUpperBlue[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainLowRed[j] != _t_struCnfc.struLevelCamera[i].nDigiGainLowRed[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) red dig gain(low byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainLowRed[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainLowGreen[j] != _t_struCnfc.struLevelCamera[i].nDigiGainLowGreen[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) green dig gain(low byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainLowGreen[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nDigiGainLowBlue[j] != _t_struCnfc.struLevelCamera[i].nDigiGainLowBlue[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) blue dig gain(low byte):%d", i, j, struCnfc.struLevelCamera[i].nDigiGainLowBlue[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nEjectorBegin[j] != _t_struCnfc.struLevelCamera[i].nEjectorBegin[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) ejector start:%d", i, j, struCnfc.struLevelCamera[i].nEjectorBegin[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nEjectorEnd[j] != _t_struCnfc.struLevelCamera[i].nEjectorEnd[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) ejector end:%d", i, j, struCnfc.struLevelCamera[i].nEjectorEnd[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nContraPosBias[j] != _t_struCnfc.struLevelCamera[i].nContraPosBias[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) contraPosBias:%d", i, j, struCnfc.struLevelCamera[i].nContraPosBias[j]);
            }
            ...
            if (struCnfc.struLevelCamera[i].nContraPosCorrect[j] != _t_struCnfc.struLevelCamera[i].nContraPosCorrect[j])
            {
                ...
                LOG_INFO_FMT("camera(level:%d,camera No.:%d) contraPosBias:%d", i, j, struCnfc.struLevelCamera[i].nContraPosCorrect[j]);
            }
    ...
    if (struCnfc.nRefRed != _t_struCnfc.nRefRed)
    {
        ...
        LOG_INFO_FMT("camera red reference:%d", struCnfc.nRefRed);
    }
    ...
    if (struCnfc.nRefGreen != _t_struCnfc.nRefGreen)
    {
        ...
        LOG_INFO_FMT("camera green reference:%d", struCnfc.nRefGreen);
    }
    ...
    if (struCnfc.nRefBlue != _t_struCnfc.nRefBlue)
    {
        ...
        LOG_INFO_FMT("camera blue reference:%d", struCnfc.nRefBlue);
    }
    ...
    if (struCnfc.nSensorRowFre != _t_struCnfc.nSensorRowFre)
    {
        ...
        LOG_INFO_FMT("camera sensor row frequency:%d", struCnfc.nSensorRowFre);
    }
    /* lens type */
    if (struCnfc.nLensType != _t_struCnfc.nLensType)
    {
        setting.setValue(QString("%1-%2").arg(2).arg(8), struCnfc.nLensType);
        LOG_INFO_FMT("camera lens type:%d", struCnfc.nLensType);
    }
    ...
    if (struCnfc.nSensorPixel != _t_struCnfc.nSensorPixel)
    {
        ...
        LOG_INFO_FMT("camera sensor pixel:%d", struCnfc.nSensorPixel);
    }
    ...
    if (struCnfc.nChannelRangeBegin != _t_struCnfc.nChannelRangeBegin)
    {
        ...
        LOG_INFO_FMT("camera channel range begin:%d", struCnfc.nChannelRangeBegin);
    }
    ...
    for (int i = 0; i < MAX_LEVEL; i++)
    {
        if (struCnfc.nSensorPixelLevel[i] != _t_struCnfc.nSensorPixelLevel[i])
        {
            ...
            LOG_INFO_FMT("camera(level:%d) sensor pixel:%d", i, struCnfc.nSensorPixelLevel[i]);
        }
    }
    /*PMT*/
    if (struCnfc.nPMTFrameFront != _t_struCnfc.nPMTFrameFront)
    {
        ...
        LOG_INFO_FMT("camera PMT front frame begin:%d", struCnfc.nPMTFrameFront);
    }
    if (struCnfc.nPMTFrameRear != _t_struCnfc.nPMTFrameRear)
    {
        setting.setValue(QString("%1-%2").arg(2).arg(16), struCnfc.nPMTFrameRear);
        LOG_INFO_FMT("camera PMT rear frame begin:%d", struCnfc.nPMTFrameRear);
    }
    ...
    if (struCnfc.nRearRefRed != _t_struCnfc.nRearRefRed)
    {
        ...
        LOG_INFO_FMT("camera rear red reference:%d", struCnfc.nRearRefRed);
    }
    ...
    if (struCnfc.nRearRefGreen != _t_struCnfc.nRearRefGreen)
    {
        ...
        LOG_INFO_FMT("camera rear green reference:%d", struCnfc.nRearRefGreen);
    }
    ...
    if (struCnfc.nRearRefBlue != _t_struCnfc.nRearRefBlue)
    {
        ...
        LOG_INFO_FMT("camera rearblue reference:%d", struCnfc.nRearRefBlue);
    }
