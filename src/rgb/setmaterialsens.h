...
private:
    ...
    QWidget* pageGeneral;                   // 0：通用
    QWidget* pageAI;                        // 2: 传统智能
    QWidget* pageShape;                     // 1: 形选
    QWidget* pagePeanut;
    ...
    //模型参数
    QHBoxLayout* paraModelHLayout[MODEL_MAX_CLS_NUM];
    QVBoxLayout* pageModelParaLayout;
    ModelClsParam   modeParaArr[MODEL_MAX_CLS_NUM];
    myCustomCheckBox* modelNameCbx[MODEL_MAX_CLS_NUM];
    myLabel* thresholdLbl[MODEL_MAX_CLS_NUM];
    myLineEdit* thresholdLineEdit[MODEL_MAX_CLS_NUM];
