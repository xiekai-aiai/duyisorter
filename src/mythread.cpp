...
//                myFlow.ejectOff();
    ...
    if (((struGsh.bAlarmPressure & 0x02) != 0)&&(struGsh.bStatFeed == 1
         || (struGsh.bStatFeed == 0 && struGsh.bAlarmCloseFeed==true ))) {//开下料报警、应报警关闭下料两种情况要弹框提醒
        if (m_nPreAlarmPressure != struGsh.bAlarmPressure) {  // 新的报警
    ...
    if (struGsh.bStatFeed == 1) { //在开下料状态下才更新上次气压状态
...
void getStatusThread::writeAlamLog()
{
    ...
    if(struGsh.bAlarmPressure != (struGsh.nAlarmStatus & 0x11)) {
        ...
        myLog->info(LOG_WARM, myLan.pressure_alarm + QString(": ") + str);
    }
    ...
    if(struGsh.bAlarmBlower != ((struGsh.nAlarmStatus >> ALARM_ID_BLOWER)&0x01)){
        ...
        myLog->info(LOG_WARM, myLan.blower_alarm + QString(": ")+ str);
    }
    ...
    if((struGsh.bStatBelt[0] || struGsh.bStatBelt[1]) != ((struGsh.nAlarmStatus >> ALARM_ID_BELT)&0x01)){
        ...
        myLog->info(LOG_WARM, myLan.belt_1_status + QString(": ")+ str);
        ...
        myLog->info(LOG_WARM, myLan.belt_2_status + QString(": ")+ str);
    }
    ...
    if(struGsh.nCommStat != ((struGsh.nAlarmStatus >> ALARM_ID_COMM) & 0x01)){
        ...
        myLog->info(LOG_WARM,myLan.communication_alarm + QString(": ") + str);
    }
}
